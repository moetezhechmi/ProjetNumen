...
function afficherInstallation ($installation){
		...
		echo "Delai: ".$installation->getDelai()."<br>";
	...
	function ajouterInstallation($installation){
		$sql="insert into installation (numero_inst,id_client,nombre_produit,progres,prix,date_debut,delai) values (:numero_inst,:id_client,:nombre_produit,:progres,:prix,:date_debut,:delai)";
	...
	function modifierInstallation($installation,$numero_inst){
		$sql="UPDATE installation SET numero_inst=:numero_instt,id_client=:id_client,nombre_produit=:nombre_produit,progres=:progres,prix=:prix,date_debut=:date_debut,delai=:delai WHERE numero_inst=:numero_inst";
...
try{		
		...
		':date_debut'=>$date_debut,':delai'=>$delai);
	...
	function tri_delai(){
		$sql="SELECT * from installation ORDER BY delai DESC";
		$db = config::getConnexion();
		try{
		$liste=$db->query($sql);
		return $liste;
	...
	function rechercherListeInstallations($enter){
		$enter="%$enter%";
		$sql="SELECT * from installation where numero_inst like '$enter' or id_client like '$enter' or nombre_produit like '$enter' or progres like '$enter' or prix like '$enter' or date_debut like '$enter' or delai like '$enter'";
		$db = config::getConnexion();
		try{
		$liste=$db->query($sql);
		return $liste;
