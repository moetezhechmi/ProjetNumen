        ...
        <ul class="nav navbar-nav">
           ...
           <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="hidden-xs"><?php if($_SESSION['email']!=null){echo $_SESSION['email'];} ?></span>
            </a>
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="deconnexion.php" class="btn btn-default btn-flat">Deconnexion</a>
                </div>
              </li>
            </ul>
          </li>
    ...
    <section class="sidebar">
      ...
      <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="loginAdmin.php"><i class="fa fa-circle-o"></i> Login</a></li>
            <li><a href="ajouterAdmin.html"><i class="fa fa-circle-o"></i> Register</a></li>
            <li><a href="afficherClient.php"><i class="fa fa-circle-o"></i> Consulter clients</a></li>
            <li><a href="afficherAdmin.php"><i class="fa fa-circle-o"></i> Consulter Admins</a></li>
  ...
  <tbody>
          <?php foreach ($listeClients as $row): ?> 
              <tr>
                ...
                <td><?PHP if($row['confirm']==1){echo "Activé";}else{echo"desactivé";} ; ?></td>
                <td>
      ...
      <div class="row no-print">
        <div class="col-xs-12">
          ...
          <form name="f" action="pdf.php" method="post">
                     <input type="hidden" value="<?PHP echo $row['id']; ?>" name="id">
                     <button type="submit" name="del" value="supprimer" class="btn btn-danger">pdf</button>
                  </form>
        </div>
      </div>
    </section>
