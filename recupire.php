...
<div class="billing checkout_section">
						<div class="section_title">Récupération de mot de passe</div>
						
						<div class="checkout_form_container">
							<form  method="post" class="default-form">
								<input type="email" name="recup_mail" class="checkout_input" placeholder="votre adresse mail" /><br />
								<input type="submit" name="recup_submit"  value="Valider" />
								<?php include 'recupiration.php'; ?>
		                   </form>
		                   <?php if (isset($error)) {
