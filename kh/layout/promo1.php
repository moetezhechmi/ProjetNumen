...
?>
            ...
            <form method="POST" action="name1.php" style="display:inline;">
              ...
              <form method="POST" action="date1.php" style="display:inline;">
                <button type="submit" name="date" class="btn btn-primary">Display by Debut</button>
              </form>
                <form method="POST" action="hour1.php" style="display:inline;">
                <button type="submit" name="hour" class="btn btn-primary">Display by Percentage</button>
              </form>
              </div>
            </div>
          </div>
