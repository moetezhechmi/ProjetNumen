    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="fixed.php"><i class="fa fa-circle-o"></i> Gestion des Commandes</a></li>
            <li><a href="../tables/fixed.php"><i class="fa fa-circle-o"></i> Gestion des factures</a></li>
          </ul>
        </li>
        <li>
...
if (isset($_POST["trie"])){
  $listecommandes=$employeC->trierCommandes($_POST["trie"]);
}
?>
                <table class="table">
<tr>
