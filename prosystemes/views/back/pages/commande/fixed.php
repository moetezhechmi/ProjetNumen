...
?>
    ...
    <div class="box box-warning">
            ...
            <div class="form-group">
                  <label>id de la commande</label>
                  <input type="text"  name="idC" class="form-control" placeholder="Enter un id de la commande a modifier...">
                </div>
            <div class="form-group">
                  <label>id du client</label>
                  <input type="text"  name="idClient" class="form-control" placeholder="Enter id du client">
          ...
          <div class="box box-danger">
            <div class="box-header">
              <h3 class="box-title">Supprimer Commande</h3>
            </div>
            <div class="box-body">
              <div class="form-group">
                  <label>id de lacommande</label>
                  <input type="text"  name="idC" class="form-control" placeholder="Enter le nom de la commande à supprimer...">
                </div>
            </div>
            <!-- /.box-body -->
            <div class="box-footer">
