...
$listeInstallations=$installation1C->tri_numeros();
$listeInstallationss=$installation1C->tri_numero();

?>

<form method="POST" action="inst1_tri.php">
   ...
   <div class="form-group">
                ...
                <select type="submit" class="form-control select2" id="tri" style="width: 100%;">
                  <option></option>
                  <option id="numero">Numero</option>
                  <option id="date_fin">Date fin</option>
                  <option id="progres">Progrès</option>
                </select>
              </div>
                       <div class="form-group">
                <label>Ordre:</label>
                <select class="form-control select2" style="width: 100%;">
                  <option selected="selected" id="ASC">Croissant</option>
                  <option id="DESC">Décroissant</option>
                  </select>
              </div>
...
<?PHP
foreach($listeInstallationss as $row){
  ?>
  <tr>
  <td><?PHP echo $row['numero_inst']; ?></td>
  <td><?PHP echo $row['id_client']; ?></td>
...
?>
                <!--form method="POST" action="" style="display:inline;">
                    <div class="form-group">
                <label>Trier par:</label>
                <select class="form-control select2" id="tri" style="width: 100%;">
                  <option selected="selected" id="numero">Numero</option>
                  <option id="date_fin">Date fin</option>
                  <option id="progres">Progrès</option>
                </select>
              </div>
