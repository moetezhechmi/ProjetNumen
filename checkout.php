			...
			<div class="row">
							...
							<form action="#" id="checkout_form" class="checkout_form">
								<div class="row">
									<div class="col-xl-6">
										...
										<input type="text" id="checkout_name" class="checkout_input" required onkeyup="lettersonly(this)">
									</div>
									<div class="col-xl-6 last_name_col">
										<!-- Last Name -->
										<label for="checkout_last_name">Last Name*</label>
										<input type="text" id="checkout_last_name" class="checkout_input" required onkeyup="lettersonly(this)">
									</div>
								</div>
								<div>
									<!-- Company -->
								...
								<div>
									...
									<input type="text" id="checkout_zipcode" class="checkout_input" required onkeyup="numbersonly(this)">
								</div>
								<div>
									<!-- City / Town -->
								...
								<div>
									...
									<input type="phone" id="checkout_phone" class="checkout_input" required onkeyup="numbersonly(this)">
								</div>
								<div>
									<!-- Email -->
									<label for="checkout_email">Email Address*</label>
									<input type="phone" id="checkout_email" required placeholder="mail@serveur.com" class="checkout_input" required="required">
								</div>
				...
				<div class="col-lg-6">
					<div class="order checkout_section">
						...
						<div class="button order_button"><a href="connexion.html">Place Order</a></div>
					</div>
				</div>
			</div>
		</div>
