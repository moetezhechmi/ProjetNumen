					...
					<div class="row">
						<div class="col">
							<div class="home_content">
								<div class="home_title">Televisions et Accessoires<span>.</span></div>
			...
			<div class="row">
				<div class="col">
					...
					<div class="product_grid">
						...
						<!-- Product -->
						<div class="product">
							<div class="product_image"><img src="img/111.jpg" alt=""></div>
							<div class="product_extra product_new"><a href="categories.php">New</a></div>
							<div class="product_content">
								<div class="product_title"><a href="product-111.html">Television SAMSUNG</a></div>
