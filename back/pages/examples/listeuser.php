      ...
      <h1> liste des utilisateurs </h1>
        <ul>
        	<?php foreach ($client as $client): ?> 
        		<li>
        	    	<?= $client['id'] ?> - <?= $client['nom'] ?> - <?= $client['prenom'] ?> - <?= $client['date_naissance'] ?> - <?= $client['sexe'] ?> - <?= $client['code_postal'] ?> - <?= $client['ville'] ?> - <?= $client['num_tel'] ?> - <?= $client['email'] ?> - <?= $client['password'] ?> 

                <form name="f" action="supprimeruser.php" method="post">
                  <input type="hidden" name="id" value="<?= $client['id'] ?>" >
                  <input type="hidden" name="email" value="<?= $client['email'] ?>" >
                  <button type="submit" name="del" value="supprimer">supprimer</button>
                </form>
        		</li>
      <?php endforeach; ?>
       </ul>
