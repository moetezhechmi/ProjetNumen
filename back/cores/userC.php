...
function afficherUser ($employe){
	...
	function ajouterEmploye($employe){
		...
		$sql="INSERT INTO client( nom, prenom, date_naissance, sexe, code_postal, ville, num_tel, email, password) VALUES (:nom, :prenom, :date_naissance, :sexe, :code_postal, :ville, :num_tel, :email, :password)";
		...
		$req->bindValue(':date_naissance',$employe->getDate_naissance());
		$req->bindValue(':sexe',$employe->getSexe());
        $req->bindValue(':code_postal',$employe->getCode_postal());
		$req->bindValue(':ville',$employe->getVille());
		$req->bindValue(':num_tel',$employe->getNum_tel());
